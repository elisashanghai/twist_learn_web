...
function showSubtitleInstructions() {
    ...
    const subtitleInstructions = document.querySelectorAll("[id^='subtitle-instructions-']");
    subtitleInstructions.forEach((instruction) => {
        instruction.style.display = "none";
    });

    const instructionElement = document.getElementById(`subtitle-instructions-${language}`);
    if (instructionElement) {
        instructionElement.style.display = "block";
    } else {
        console.warn(`Subtitle instructions for "${language}" not found. Defaulting to English.`);
